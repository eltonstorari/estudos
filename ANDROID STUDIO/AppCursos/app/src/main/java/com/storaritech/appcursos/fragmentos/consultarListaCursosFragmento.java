...
import com.storaritech.appcursos.adaptador.CursosAdapter;
...
public class consultarListaCursosFragmento extends Fragment  implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerCursos= (RecyclerView) vista.findViewById(R.id.idRecyclerCurso);
    ...
    private void carregarWEBService() {
        ...
        String url = ip + "/webservices/consultarListaImagem.php";
